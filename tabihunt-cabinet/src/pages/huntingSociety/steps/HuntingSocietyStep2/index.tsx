...
const HuntingSocietyStep2 = () => {
    ...
    return(
        <div className="new-hunting-society-step2">
      <h2>Время работы</h2>
      <div className="new-hunting-society-step2__form">
        <div className="new-hunting-society-step2__form-item">
          <h3>День недели</h3>
...
export default HuntingSocietyStep2
